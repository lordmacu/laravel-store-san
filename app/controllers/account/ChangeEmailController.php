...
class ChangeEmailController extends AuthorizedController {
	...
	public function postIndex()
	{
		...
		if ( ! $user->checkPassword(Input::get('current_password')))
		{
			...
			$this->messageBag->add('current_password', 'Tu actual contraseña es incorrecta');
		...
		return Redirect::route('change-email')->with('success', 'Tu email se ha actualizado correctamente');
	}
