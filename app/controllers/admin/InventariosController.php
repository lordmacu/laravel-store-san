...
class InventariosController extends AdminController {
	...
	public function getIndex()
	{
		...
		// Show the page
		//return View::make('backend/inventarios/index', compact('inventarios'));
	}
	...
	public function getCreate()
	{
		...
		// Show the page
		return View::make('backend/inventarios/create', compact('groups', 'selectedGroups', 'permissions', 'selectedPermissions'));
	}
