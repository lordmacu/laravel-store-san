...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('inventarios') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> Back</a>
		</div>
	</h3>
</div>
...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<div class="control-group">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">Create Inventario</button>
		</div>
	</div>
</form>
@stop
