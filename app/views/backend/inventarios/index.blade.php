...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('create/inventarios') }}" class="btn btn-small btn-info"><i class="icon-plus-sign icon-white"></i> Ingresar  Inventario</a>
		</div>
	</h3>
</div>

<!--<a class="btn btn-default" href="{{ URL::to('admin/users?withTrashed=true') }}">Incluir usuarios borrados</a>
<a class="btn btn-default" href="{{ URL::to('admin/users?onlyTrashed=true') }}">Solo usuarios borrados</a>-->
