...
<div class="row">
	...
	<div class="col-sm-12 camposform">
		{{ Form::label('codigo_tienda', 'Tienda') }}
		<div>
			{{ Form::select('codigo_tienda',$inventarios,"selector",array("placeholder"=>"selecciona una tienda","class"=>"form-control","class"=>"select","id"=>"codigo_tienda","style"=>"width:200px") )}}
		</div>
		{{ $errors->first('codigo_tienda', '<span class="help-inline">:message</span>') }}
	</div>

	<div class="col-sm-12 camposform">

		<input type="checkbox" name="seleccion_producto" id="seleccion_producto"  style="display:block"/>
	...
	<div class="col-sm-12 camposform">
		...
		<input type="checkbox" name="seleccion_plu" id="seleccion_plu"  style="display:block"/>
